...
import { w as useState, k as useRuntimeConfig } from '../server.mjs';
import { defineComponent, toRefs, computed, useSlots, useSSRContext, h } from 'vue';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-52418a78.mjs';
import { u as useContentPreview } from './preview-96e76c6c.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-776d792c.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-07510df4.mjs.map
