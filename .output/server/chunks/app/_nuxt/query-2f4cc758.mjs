import { E as withLeadingSlash, j as joinURL, D as withoutTrailingSlash, F as withBase, B as hash } from '../../nitro/node-server.mjs';
import { k as useRuntimeConfig, t as useRequestEvent } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-60801126.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-2f4cc758.mjs.map
