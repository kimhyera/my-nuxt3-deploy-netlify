...
const layouts = {
  custom: () => import('./Custom-1eb996de.mjs').then((m) => m.default || m),
  default: () => import('./default-e9eae68e.mjs').then((m) => m.default || m),
  link1: () => import('./link1-77102607.mjs').then((m) => m.default || m),
  "link2-main": () => import('./main-e2998c36.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=nuxt-layout-87061b2d.mjs.map
